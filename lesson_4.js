...
//
// const result = user.toLowerCase().includes(searchString)
// console.log(result)
...
// // const result = users.find(user => user.toLowerCase().includes(searchUser))
// // console.log(result)
// const result = users.filter( user => user.toLowerCase().includes(searchUser))
// console.log(result)
